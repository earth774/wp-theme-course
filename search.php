        ...
        <div class="container">
            ...
            <div class="menu-type">
                ...
                <div class="menu-list">
                    ...
                    <div class="menu-item">
                        ...
                        <div class="menu-action">
                            <div class="row">
                                <!-- stock -->
                                <div class="col-6">
                                    <p class="menu-stock in">In Stock</p>
                                </div>
                                <!-- price -->
                                <div class="col-6">
                    ...
                    <!-- item 2 -->
                    <div class="menu-item">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/drink-2.jpg" alt="Drink 2" class="menu-image">
                        <p class="menu-name">ลาเต้ วิปปิ้งพอร์ตโต้</p>
                        <p class="menu-description">วิปครีมสูตรพิเศษผสมกลิ่นมาร์ชแมลโลว์ด้านล่าง ราดด้วยซอสมอคค่า สลับชั้นด้วยกาแฟปั่น ท็อปด้วยวิปครีมมาร์ชแมลโลว์และมาร์ชแมลโลว์เต็มคำ</p>
                        <div class="menu-action">
                            <div class="row">
                    ...
                    <!-- item 3 -->
                    <div class="menu-item">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/drink-3.jpg" alt="Drink 3" class="menu-image">
                        <p class="menu-name">ลาเต้ วิปปิ้งพอร์ตโต้</p>
                        <p class="menu-description">วิปครีมสูตรพิเศษผสมกลิ่นมาร์ชแมลโลว์ด้านล่าง ราดด้วยซอสมอคค่า สลับชั้นด้วยกาแฟปั่น ท็อปด้วยวิปครีมมาร์ชแมลโลว์และมาร์ชแมลโลว์เต็มคำ</p>
                        <div class="menu-action">
                            <div class="row">
