                ...
                <div class="col-lg-4 col-xl-3">
                    <div class="sidebar-wrapper">
                        <div class="sidebar-item">
                            <ul>
                                <li>
                                    <a href="#beverages">เมนูเครื่องดื่ม</a>
                                </li>
                                <li>
                                    <a href="#breakfast">อาหารเช้า</a>
                                </li>
                                <li>
                                    <a href="#kids">เมนูคุณหนู</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="menu-slider">
                                ...
                                <?php if ($beverages->have_posts()) : ?>
                                    <?php while ($beverages->have_posts()) : $beverages->the_post(); ?>
                                        <div class="menu-item">
                                            <img src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'product') ?>" alt="<?php the_title() ?>" class="menu-image">
                                            ...
                                            <div class="menu-action">
                                                <div class="row">
                                                    <!-- stock -->
                                                    <div class="col-6">
                                                        <p class="menu-stock in"><?php the_field('stock_status') ?></p>
                                                    </div>
                                                    <!-- price -->
                                                    <div class="col-6">
                                                        <p class="menu-price"><?php the_field('price') ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
